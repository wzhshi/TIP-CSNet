function [net,stats] = cnn_CSNetPlus_train_dag(net, imdb, getBatch, varargin)
...
for p=1:numel(net.params)
  ...
  switch net.params(p).trainMethod
    ...
    threshold = net.meta.gradthresh;
    state.momentum{p}(state.momentum{p}>threshold/thisLR) = threshold/thisLR;
    state.momentum{p}(state.momentum{p}<-threshold/thisLR) = -threshold/thisLR;
